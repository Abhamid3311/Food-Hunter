        ...
        <div className="mt-16">
            ...
            <div className="flex items-start justify-between gap-3">
                ...
                <div>
                    ...
                    <p className=" text-secondaryGray w-[550px] mt-5">Righteous indignation and dislike men who are so beguiled and demoralized by the charms of pleasure of the moment, so blinded by desires, that they cannot foresee.</p>
